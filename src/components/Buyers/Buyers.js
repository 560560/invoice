...
const Buyers = ({
  ...
  let setSort = (e) => {
    ...
    prevSelectedSortElId &&
      document.getElementById(prevSelectedSortElId).classList.remove("active");
  ...
  for (
    let number = 1;
    number <= Math.ceil(buyers.length / buyersPerPage);
    number++
  ) {
    items.push(
      <Pagination.Item
  ...
  return (
    <Container>
      ...
      <Search
        setNameSearchSelector={setNameSearchSelector}
        nameSearchSelector={nameSearchSelector}
      />
      {buyers.length === 0 && (
        <Row className="justify-content-center mt-5 mb-3 ml-2 mr-2">
          <div className="font-weight-bold" style={{ color: "red" }}>
            К сожалению, нет покупателя с таким именем
          </div>
        </Row>
      )}
      <Row className="mb-2">
        ...
        <Table striped bordered hover>
                ...
                <div className="header_col">
                  ...
                  <div className="sorting__arrows">
                    <img
                      onClick={setSort}
                      src={arrowUp}
                      id="averageCheck increase"
                      alt="arrowUp"
                    />
                    <img
                      onClick={setSort}
                      src={arrowDown}
                      id="averageCheck decrease"
                      alt="arrowDown"
                    />
                  </div>
                </div>
                ...
                <div className="header_col">
                  ...
                  <div className="sorting__arrows">
                    <img
                      onClick={setSort}
                      src={arrowUp}
                      id="purchaseCount increase"
                      alt="arrowUp"
                    />
                    <img
                      onClick={setSort}
                      src={arrowDown}
                      id="purchaseCount decrease"
                      alt="arrowDown"
                    />
                  </div>
                </div>
                ...
                <div className="header_col">
                  ...
                  <div className="sorting__arrows">
                    <img
                      onClick={setSort}
                      src={arrowUp}
                      id="totalRevenue increase"
                      alt="arrowUp"
                    />
                    <img
                      onClick={setSort}
                      src={arrowDown}
                      id="totalRevenue decrease"
                      alt="arrowDown"
                    />
                  </div>
                </div>
          ...
          <tbody>
            ...
            {buyersPerPage === 5 &&
              buyers
                .slice(
                  buyersPerPage * activePage - buyersPerPage,
                  buyersPerPage * activePage
                )
                .map((buyer) => <BuyerItem key={buyer.id} buyer={buyer} />)}
          </tbody>
        </Table>
